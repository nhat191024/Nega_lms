        ...
        <div class="card-body">
            <form action="{{ route('assignments.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control" placeholder="Enter assignment description"
                        rows="3"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="time" name="duration" id="duration" class="form-control"
                        placeholder="Enter duration" value="00:15:00">
                </div>

                <div class="form-group">
                    <label for="totalScore">Total Score</label>
                    <input type="number" name="totalScore" id="totalScore" class="form-control"
                        placeholder="Enter total score" min="0">
                </div>
