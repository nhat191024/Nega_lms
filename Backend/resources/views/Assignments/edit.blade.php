                    ...
                    <form action="{{ route('assignments.update', $assignment->id) }}" method="POST">
                            ...
                            <select name="creator_id" id="creator_id" class="form-control" required>
                                @foreach ($users as $user)
                                    <option value="{{ $user->id }}"
                                        {{ $user->id === $assignment->creator_id ? 'selected' : '' }}>
                                        {{ $user->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control" required>
                                <option value="published" {{ $assignment->status == 'published' ? 'selected' : '' }}>
                                    Published</option>
                                <option value="ongoing" {{ $assignment->status == 'ongoing' ? 'selected' : '' }}>Ongoing
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="level" id="level" class="form-control" required>
                                <option value="college" {{ $assignment->level == 'college' ? 'selected' : '' }}>Cao đẳng
                                </option>
                                <option value="university" {{ $assignment->level == 'university' ? 'selected' : '' }}>Đại
                                    học</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="duration" id="duration" class="form-control"
                                value="{{ $assignment->duration }}" min="1" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="totalScore" id="totalScore" class="form-control"
                                value="{{ $assignment->totalScore }}" min="0" required>
                        </div>

                        <!-- Specialized -->
                        <div class="form-group">
                            <label for="specialized">Specialized</label>
                            <input type="text" name="specialized" id="specialized" class="form-control"
                                value="{{ $assignment->specialized }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="subject" id="subject" class="form-control"
                                value="{{ $assignment->subject }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="topic" id="topic" class="form-control"
                                value="{{ $assignment->topic }}" required>
                        </div>
