    ...
    <div id="content">
        <section class="controller px-3">
            <ul class="nav nav-tabs" id="myTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="quiz-bank-cancel-tab" data-bs-toggle="tab" href="#quiz-bank-cancel"
                        role="tab" aria-controls="quiz-bank-cancel" aria-selected="false">Kho quiz đã đóng</a>
                </li>
            </ul>
            @php
                $indexRender = 1;
                                ...
                                <div class="table-responsive">
                                    <table id="quiz" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th>STT</th>
>>>>>>> a53935bda26be9ca45b08a06e9cdab3eb91fe78d
                                                <th> Người tạo</th>
                                                <th>Tên kho</th>
                                                <th>Mô tả</th>
...
=======
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button"
                                                                                ...
                                                                                data-bs-dismiss="modal">Đóng</button>
                                                                            <button type="button"
                                                                                class="btn btn-primary addQuestion">Thêm
                                                                                câu
                                                                                hỏi</button>
                                                                        </div>
                                                                        <script>
...
=======
                ...
                <div class="tab-pane fade show" id="quiz-bank-show" role="tabpanel"
...
=======
                                                            ...
                                                            <!-- Modal -->
                                                            <div class="modal fade"
                                                                id="showQuestion_{{ $indexRender }}" tabindex="-1"
                                                                aria-labelledby="showQuestion" aria-hidden="true">
>>>>>>> a53935bda26be9ca45b08a06e9cdab3eb91fe78d
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                        <!-- Modal Header -->
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label for="description"
                                                                                        class="form-label">Mô tả</label>
                                                                                    <textarea name="quiz_description" class="form-control" id="description" rows="3"
                                                                                        placeholder="Nhập mô tả">{{ $quiz->description }}</textarea>
                                                                                </div>
                                                                                <div class="mb-3">
                                                                                    <label for="category"
