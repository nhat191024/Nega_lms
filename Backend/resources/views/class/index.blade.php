                                    ...
                                    <div class="row g-3 needs-validation" novalidate>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input name="code" type="text"
                                                ...
                                                placeholder="Vd: ABC123" value="{{ old('code') }}">
                                            @error('code')
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input name="name" type="text"
                                                ...
                                                placeholder="Vd: Lớp bá đạo" value="{{ old('name') }}">
                                            @error('name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input name="description" type="text"
                                                ...
                                                id="description" placeholder="Vd: Hơn 30 học sinh giỏi"
                    ...
                    <div class="card-header py-3 d-flex justify-content-between">
                        ...
                        <div>
                            <button type="button" class="btn btn-warning">
                                <a href="{{ route('classes.editClass', $class->id) }}"
                                    class="text-white text-decoration-none">Sửa</a>
                            </button>
                        ...
                        <div class="modal fade" id="add-student-to-class-{{ Str::slug($class->name) }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <form action="{{ route('classes.addStudent') }}" method="post">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="modal-title-{{ Str::slug($class->name) }}">
                                                Thêm học sinh vào Lớp {{ $class->name }}</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                    ...
                    @if ($class->students && $class->students->isNotEmpty())
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="table-{{ Str::slug($class->class_name) }}"
