...
class LoginScreen extends GetView<LoginController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ResponsiveLayout(
        mobile: _buildMobile(context, screenHeight),
  ...
  Widget _buildMobile(context, screenHeight) {
                    ...
                    () => TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                          borderSide:
                              BorderSide(color: controller.isPasswordError.value ? CustomColors.errorMain : CustomColors.primaryText, width: 1),
                          borderRadius: BorderRadius.circular(14),
                        ),
  ...
  Widget _buildDesktop(context) {
    final screenHeight = MediaQuery.of(context).size.height;
    return SingleChildScrollView(
      child: Column(
        children: [
          Padding(
            padding: EdgeInsets.fromLTRB(100, 60, 200, screenHeight * 0.1),
            child: Row(
